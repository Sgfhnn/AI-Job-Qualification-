            ...
            <div className="w-full max-w-md relative z-10">
                <div className="glass p-8 rounded-2xl shadow-2xl space-y-8 animate-in fade-in zoom-in duration-500">
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-gray-500">Join us to streamline your hiring process</p>
                    </div>
                    ...
                    <form onSubmit={handleSignUp} className="space-y-6">
                        ...
                        {message && (
                            <div className="p-3 text-sm text-green-500 bg-green-50 border border-green-200 rounded-lg animate-in slide-in-from-top-2">
                                {message}
                            </div>
                        )}
                    ...
                    <div className="text-center text-sm text-gray-500">
                        ...
                        <Link href="/auth/signin" className="font-semibold text-primary hover:underline underline-offset-4 transition-all">
                            Sign in
                        </Link>
                    </div>
                </div>
