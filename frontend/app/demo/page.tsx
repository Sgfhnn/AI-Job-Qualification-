        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-12">
            ...
            <div className="flex items-start space-x-8">
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Autonomous AI Voice Interview</h3>
                <p className="text-gray-600 mb-4">
                  Qualified candidates are invited to a live voice interview with our AI agent. The interviewer asks clarifying questions, evaluates soft skills, and assesses technical depth through natural conversation.
                </p>
                <div className="bg-gray-50 rounded-lg p-4">
                  <p className="text-sm text-gray-700 font-medium">How it works:</p>
                  <ul className="text-sm text-gray-600 mt-1 list-disc list-inside">
                    <li>Natural Language Processing for fluid conversation</li>
                    <li>Sentiment and emotion analysis</li>
                    <li>Automatic transcription and scoring</li>
                    <li>Detailed post-interview reports</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-8">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 mb-4">
                  Review the full candidate profile, including resume analysis, application data, and the AI voice interview score. Make confident hiring decisions backed by data.
                </p>
                <div className="bg-gray-50 rounded-lg p-4">
                  <p className="text-sm text-gray-700 font-medium">Dashboard features:</p>
                  <ul className="text-sm text-gray-600 mt-1 list-disc list-inside">
                    <li>Interview recordings and transcripts</li>
                    <li>Cross-candidate comparison</li>
                    <li>AI-generated hiring recommendations</li>
                  </ul>
                </div>
              </div>
            </div>
